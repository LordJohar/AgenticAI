...
# مثال‌های Python مسیر شخصی — هفتهٔ اول

این مثال‌ها مکمل مسیر شخصی‌سازی‌شده‌اند و برای تمرین application engineering با LLM نوشته شده‌اند. تمام Commandها را از داخل همین پوشه اجرا کنید.
